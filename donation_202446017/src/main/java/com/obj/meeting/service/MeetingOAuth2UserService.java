...
public class MeetingOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if(registrationId.equals("naver")){
            ...
            // 이메일은 kakao_account.email에 존재
            Map<String, Object> kakaoAccount = oAuth2User.getAttribute("kakao_account");
            if (kakaoAccount != null) {
                email = (String) kakaoAccount.get("email");
            }

            // 닉네임은 properties.nickname에 존재
...
//            Map<String, Object> attribute = oAuth2User.getAttribute("properties");
//            name = attribute.get("nickname").toString();
